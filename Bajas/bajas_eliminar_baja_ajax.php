...
$sql = "INSERT INTO auditorias (fecha, hora, usuario, accion, detalles) VALUES ('$hoy','$ahora','$user','Eliminar Baja','Id Artículo: " . $id_alta . ' - Concepto: ' . $concepto . ' - Vale: ' . $id_vale . ' - Cantidad: ' . $cantidad . "')";
$result = $conn->query($sql);
