...
//CREA NUEVA BAJA
if ($concepto == "Ajuste_Negativo"){
    $concepto = "Ajuste Negativo";
}

$sql = "INSERT INTO bajas (id_vale, id_alta, fecha, hora, codigo, descripcion, marca, familia, lote, fecha_vto, cantidad, concepto) VALUES ('$id_vale', '$id_alta', '$fecha', '$hora', '$codigo', '$descripcion', '$marca', '$familia', '$lote', '$fecha_vto','$cantidad','$concepto')";
$result = $conn->query($sql);
...
$sql = "INSERT INTO auditorias (fecha, hora, usuario, accion, detalles) VALUES ('$hoy','$ahora','$user','Nueva Baja','Id Artículo: " . $id_alta . ' - Concepto: ' . $concepto . ' - Vale: ' . $id_vale . ' - Cantidad: ' . $cantidad . "')";
$result = $conn->query($sql);
