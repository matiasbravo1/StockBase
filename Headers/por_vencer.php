...
if ($result->num_rows == 0) {
    echo '<div class="text-center mt-3" style="color:#007E33;font-weight:bold;">No hay artículos por vencer.</div>';
}else{

    echo ' <div id="primero" class="row justify-content-center mt-4 mx-2">
        <p class="h4 mb-3" style="color:red;font-weight:bold">Artículos por Vencer en menos de 1 mes</p>
