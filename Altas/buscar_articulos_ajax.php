...
$sql = "SELECT * FROM articulos WHERE `activo` = '1'" . $sql_codigo . $sql_codigo_prov . $sql_descripcion . $sql_marca . $sql_familia . " ORDER BY id_articulo ASC";
...
while($row = $result->fetch_assoc()) {
	...
	echo '<tr onclick=' . '"completar(' . "'" . $row["codigo"] . "','" . $row["codigo_prov"] . "','" . $row["descripcion"] . "','" . $row["marca"] . "','" . $row["familia"]. "'" . ')">
