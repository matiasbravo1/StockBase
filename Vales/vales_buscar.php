      ...
      <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
              <button type="button" class="btn btn-md btn-primary btn-block" onclick="imprimirVales();">Vales y sus artículos</button>
...
$( document ).ready(function() {
    ...
    document.querySelector("#fecha_desde").value = x;
    document.querySelector("#fecha_hasta").value = x;
});
...
function buscar(){
		...
		ajax.send("&fecha_desde="+$("#fecha_desde").val()+"&hora_desde="+$("#hora_desde").val()+"&fecha_hasta="+$("#fecha_hasta").val()+"&hora_hasta="+$("#hora_hasta").val()+"&vale_desde="+$("#vale_desde").val()+"&vale_hasta="+$("#vale_hasta").val()+"&seccion="+$("#seccion option:selected").text()+"&descarga="+$("#descarga option:selected").val()+"&estado="+$("#estado option:selected").val()+"&usuario="+$("#usuario option:selected").text());
}
...
function agregarBaja(id_vale, id_alta, cantidad){
    var d = new Date();
    var h = new Date(d.getTime() - 180 * 60 * 1000);
    ...
    var cant = prompt("Cuantas unidades de este artículo desea descargar?", cantidad);
