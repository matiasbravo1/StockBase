...
echo '<center><span style="color:#007E33;font-weight:bold;">Artículos en Stock&nbsp<button type="button" style="background-color:transparent;border:none" onclick="ocultarStock()"><img src="../Imagenes/ojo_verde.png" height="22px"></button></span></center>';
